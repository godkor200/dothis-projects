import { radToDeg, tau } from '@dothis/share/lib/utils/mathUtils/common';
...
export type ValueInfo = {
  ...
  minLabel: string;
  maxLabel: string;
  formatter: (value: TachometerGraphProps['value']) => string;
};

export type TachometerGraphProps = {
  value: number;
  valueInfo: ValueInfo;
  data: TachometerData;
};
