import type { Prisma, RequestFunding, RequestFundingStatus, RequestPost, User } from '@prisma/client';
...
namespace RequestFundingDomain {
...
export default RequestFundingDomain;
