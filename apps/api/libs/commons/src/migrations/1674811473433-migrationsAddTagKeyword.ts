...
import { migrations1674099525331 } from '@Libs/commons/src/migrations/1674099525331-idChangeMigrations';

export class migrationsAddTagKeyword1674811473433
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    // await queryRunner.queries(`alter table channel add tag varchar(255) null`);
