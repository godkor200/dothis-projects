 ...
 * 1,6,7 일 데이터가 없음
 */
export const mergedVideoHistoryDummy = [
  {
    videoId: 'jixSzMdcjcM',
    videoViews: 2626,
    videoLikes: 135,
    videoComments: 7,
    videoPerformance: 0.0581,
    videoCluster: 21,
    year: 2024,
    month: 5,
    day: 2,
    channelAverageViews: 47437,
  },
  {
    videoId: 'ty4Dyp6JtAc',
    videoViews: 112,
    videoLikes: 9,
    videoComments: 2,
    videoPerformance: 0.061,
    videoCluster: 43,
    year: 2024,
    month: 5,
    day: 2,
    channelAverageViews: 2142,
  },
  {
    videoId: '1RL9BHEJpQM',
    videoViews: 59131,
    videoLikes: 1717,
    videoComments: 84,
    videoPerformance: 0.1609,
    videoCluster: 93,
    year: 2024,
    month: 5,
    day: 2,
    channelAverageViews: 356974,
  },
  {
    videoId: 'FgEc8H7ofdQ',
    videoViews: 728,
    videoLikes: 74,
    videoComments: 0,
    videoPerformance: 0.2438,
    videoCluster: 43,
    year: 2024,
    month: 5,
    day: 2,
    channelAverageViews: 3220,
  },
  {
    videoId: 'DUWwJHKK5YM',
    videoViews: 105,
    videoLikes: 9,
    videoComments: 0,
    videoPerformance: 0.0481,
    videoCluster: 43,
    year: 2024,
    month: 5,
    day: 2,
    channelAverageViews: 2286,
  },
  {
    videoId: 'Hs-T2vkBO2I',
    videoViews: 28,
    videoLikes: 1,
    videoComments: 0,
    videoPerformance: 0.0789,
    videoCluster: 43,
    year: 2024,
    month: 5,
    day: 2,
    channelAverageViews: 278,
  },
  {
    videoId: 'HnOBxVu2Tgo',
    videoViews: 384,
    videoLikes: 33,
    videoComments: 1,
    videoPerformance: 0.4107,
    videoCluster: 93,
    year: 2024,
    month: 5,
    day: 2,
    channelAverageViews: 949,
  },
  {
    videoId: 'XqeI90k3J7A',
    videoViews: 53,
    videoLikes: 2,
    videoComments: 0,
    videoPerformance: 0.0681,
    videoCluster: 93,
    year: 2024,
    month: 5,
    day: 2,
    channelAverageViews: 647,
  },
  {
    videoId: 'Rp5w1TMJN7A',
    videoViews: 69,
    videoLikes: 9,
    videoComments: 4,
    videoPerformance: 0.0947,
    videoCluster: 68,
    year: 2024,
    month: 5,
    day: 2,
    channelAverageViews: 733,
  },
  {
    videoId: 'J_crE5-W36c',
    videoViews: 42,
    videoLikes: 0,
    videoComments: 0,
    videoPerformance: 0.0101,
    videoCluster: 43,
    year: 2024,
    month: 5,
    day: 2,
    channelAverageViews: 4674,
  },
  {
    videoId: 'ty4Dyp6JtAc',
    videoViews: 2765,
 ...
 * @param data
 */
function calculateViewIncrements(data) {
  const result = {};
  ...
  Object.keys(data).forEach((videoId) => {
    ...
    for (let i = 1; i < videoData.length; i++) {
      const prevDay = videoData[i - 1].day;
      const currDay = videoData[i].day;
      const increment = videoData[i].videoViews - videoData[i - 1].videoViews;

      increments[currDay] = increment;
    }

    result[videoId] = increments;
  });
 ...
 *   sumByDate['3'] += view['3'] || 0;
 *   sumByDate['4'] += view['4'] || 0;
 *   sumByDate['5'] += view['5'] || 0;
 *   sumByDate['6'] += view['6'] || 0;  // 6월 6일 데이터가 없으므로 0으로 처리
 *   sumByDate['8'] += view['8'] || 0;
 * }
 * return =
 * {
 *   "3": 35999,
