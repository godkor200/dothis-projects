...
export const VIDEO_PERFORMANCE_DI_TOKEN = Symbol('VIDEO_PERFORMANCE_DI_TOKEN');
export const SUBSCRIBER_VIEW_ANALYSIS_DO_TOKEN = Symbol(
  'SUBSCRIBER_VIEW_ANALYSIS_DO_TOKEN',
);
export const DAILY_VIEW_CACHE_DI_TOKEN = Symbol('DAILY_VIEW_CACHE_DI_TOKEN');
export const REPRESENTATIVE_CATEGORY_SERVICE_DI_TOKEN = Symbol(
  'REPRESENTATIVE_CATEGORY_SERVICE_DI_TOKEN',
);
export const CATEGORY_DISTRIBUTION_DI_TOKEN = Symbol(
