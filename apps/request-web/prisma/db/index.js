...
const foundDirname =
  !regularDirname &&
  findSync(process.cwd(), ['prisma/database', 'db'], ['d'], ['d'], 1)[0];
...
const config = {
  generator: {
    ...
    output: {
      value:
        '/Users/yubyeong-gug/Desktop/project/dothis/apps/request-web/prisma/database',
      fromEnvVar: null,
    },
    config: {
      engineType: 'library',
...
path.join(
  process.cwd(),
  'prisma/database/libquery_engine-darwin-arm64.dylib.node',
);
