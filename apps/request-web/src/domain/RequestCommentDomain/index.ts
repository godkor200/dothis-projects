...
type WithChildrenComments = Pick<
  AwaitedReturn<typeof RequestCommentDomain.db.getDetailItems>[number],
  'id' | 'childrenComments' | 'rootId' | 'createdAt'
>;

namespace RequestCommentDomain {
  export interface Schema extends z.infer<typeof schema> {}

  export interface CreateSchema extends z.infer<typeof createSchema> {}
...
export default RequestCommentDomain;
