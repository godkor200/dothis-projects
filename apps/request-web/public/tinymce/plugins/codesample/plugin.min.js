    ...
    r = (function (e, t, n) {
              ...
              for (var b = 0; b < p.length; ++b) {
                ...
                for (
                  ...
                  if (!(F instanceof r)) {
                    ...
                    var N = _.prev;
                    if (
                      (B && ((N = u(t, N, B)), (x += B.length)),
                      c(t, N, S),
                      (_ = u(t, N, new r(g, f ? s.tokenize(j, f) : j, w, j))),
                      T && u(t, _, T),
                      S > 1)
                    ) {
                      var O = { cause: g + ',' + b, reach: P };
                      o(e, t, n, _.prev, x, O),
      ...
      return (
        ...
        (s.languages.markup = {
          ...
          entity: [
            { pattern: /&[\da-z]{1,8};/i, alias: 'named-entities' },
            /&#x?[\da-f]{1,8};/i,
          ],
        }),
          ...
          e.on('SetContent', () => {
            const t = e.dom,
              n = h.grep(
                t.select('pre'),
                (e) =>
                  c(e) && 'true' !== t.getAttrib(e, 'data-mce-highlighted'),
              );
            n.length &&
              e.undoManager.transact(() => {
                h.each(n, (n) => {
