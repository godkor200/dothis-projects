...
export const metadata: Metadata = {
  title: `유튜브 스튜디오 데이터 뜯어보기 (1): 트래픽 소스 분석 | 시청자 데이터 기반 콘텐츠 분석 두디스`,
  description: `유튜브 스튜디오 데이터 뜯어보기 (1): 트래픽 소스 분석, 유튜브 스튜디오를 봐야하는 이유, 트래픽 소스 데이터 분석하는 법, 데이터 분석에서 인사이트 얻는 법`,
  keywords: `두디스, 유튜브 스튜디오, 유튜브 트래픽소스, 트래픽 소스, 유튜브 분석`,
  openGraph: {
    title: `유튜브 스튜디오 데이터 뜯어보기 (1): 트래픽 소스 분석 | 시청자 데이터 기반 콘텐츠 분석 두디스`,
    description: `유튜브 스튜디오 데이터 뜯어보기 (1): 트래픽 소스 분석, 유튜브 스튜디오를 봐야하는 이유, 트래픽 소스 데이터 분석하는 법, 데이터 분석에서 인사이트 얻는 법`,
  },
