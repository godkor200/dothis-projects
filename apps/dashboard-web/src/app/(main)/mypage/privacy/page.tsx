  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>두디스 공지사항, 최신정보, 프로모션 등에 대한 안내</li>
        <li>회원들 간의 직접 메시지, 회원 문의사항에 대한 답신을 위한 경로</li>
        <li>서비스 개발을 위한 연구/조사 등의 안내</li>
      </ul>
      <h3 id="-2-">제 2조 개인정보 수집 항목</h3>
      <ul>
        <li>필수 항목 : 이메일주소, 닉네임, 비밀번호</li>
        <li>
          선택 항목 : 오픈인증을 제공하는 서비스 (구글, 페이스북, 인스타그램
          등)의 회원 인증 키, 프로필 이미지, 연락처, PUSH 알림 및 마케팅 수신
          동의 여부
        </li>
        <li>
          그 외 : 서비스 이용 또는 사업처리 과정에서 생성 수집되는 각종 캠페인
          및 개인 성향 정보 서비스 이용기록, 접속로그, 쿠키, 결제기록, 이용정지
          기록, 탈퇴 기록, 접속 단말기 모델명 등
        </li>
      </ul>
      <h3 id="-3-">제 3조 개인정보 수집 방법</h3>
      <ul>
        <li>홈페이지, 설문조사, 고객 문의, 오픈인증 서비스</li>
        <li>쿠키, 로그 분석 프로그램을 통한 생성정보</li>
      </ul>
      ...
      <h3 id="-11-privacy-policies-of-3rd-parties-we-integrate-with-">
        제 11조{' '}
      ...
      <h3 id="-12-">제 12조 개인정보 공유 및 제공</h3>
      <p>
        개인정보는 제3자에게 제공되지 않습니다. 단, 두디스와 연계된 서비스 또는
        결제와 같이 제3자의 응대가 필요한 경우, 동의를 통해 개인정보가 전달될
        수도 있습니다. 개인정보는 서비스 이용 완료 또는 고객 응대 후 파기됩니다.
      </p>
    </div>
  );
};
