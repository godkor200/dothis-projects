...
const PrivacyPage = () => {
  return (
    <div className={styles.container}>
      ...
      <br />
      <h3 id="-10-">제 10조 정책 변경에 따른 공지 의무</h3>
      <p>
      ...
      <br />
      <h3 id="-12-privacy-policies-of-3rd-parties-we-integrate-with-">
        제 12조{' '}
      ...
      <br />
      <h3 id="-13-">제 13조 개인정보 공유 및 제공</h3>
      <p>
